<template>
  <div>
    ...
    <el-button type="primary" @click="goToEditPage">修改个人信息</el-button>
        </el-main>
      </el-container>
    </el-container>
  </div>
...
export default {
  ...
  mounted() {
    ...
    // 如果本地存储中有保存的信息，则使用本地存储中的信息
    if (storedNickname && storedAccount) {
  ...
  goToEditPage() {
      // 在点击按钮时跳转到修改个人信息页面
      this.$router.push({ path: '/6_1', query: { nickname: this.nickname, account: this.account } });
    },
  }
}
</script>
